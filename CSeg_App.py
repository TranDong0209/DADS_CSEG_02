...
if page == 'Home':
    ...
    st.write("Businesses that lack the monetary aspect, like viewership, readership, or surfing-oriented products, could use Engagement parameters instead of Monetary factors. This results in using RFE – a variation of RFM. Furthermore, this Engagement parameter could be defined as a composite value based on metrics such as bounce rate, visit duration, number of pages visited, time spent per page, etc."            
             )
...
# Customer Profile Page
    ...
    st.markdown("<h1 style='color: blue; font-size: 28px;'>Customer Profiles</h1>", unsafe_allow_html=True)
...
# Business Dashboard Page
    ...
    # Header with custom color and font size
    st.markdown("<h1 style='color: blue; font-size: 28px;'>Business Activities Dashboard</h1>", unsafe_allow_html=True)
...
if page == 'Customer Segmentation':
    # Header with custom color and font size
    st.markdown("<h1 style='color: blue; font-size: 28px;'>Customer Segmentation Prediction</h1>", unsafe_allow_html=True)
...
# App description
st.sidebar.info('CSEG (Customer Segmentation by RFM using Machine Learning) is an application designed to help businesses gain deeper insights into their customer base. Leveraging RFM analysis and machine learning, CSEG enables the creation of customer segments with similar characteristics to optimize marketing strategies and enhance the customer experience.')

# Customercarecenter information
st.sidebar.subheader('Customer Care Center:')
st.sidebar.write('If you have any questions or need assistance, please contact our Customer Care Center.')

# Hotline phone number with phone symbol
st.sidebar.write('Hotline: &#9742; +1-800-999-9999')  # &#9742; is the HTML code for a phone symbol

# Email address with email symbol
st.sidebar.write('Email: \u2709️; customersupport@cseg.com')  # &#128231; is the HTML code for an email symbol
